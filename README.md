...
CREATE TABLE user_statuses (ID SERIAL PRIMARY KEY, platform platform NOT NULL, user_id VARCHAR(30) NOT NULL, post_id VARCHAR(30), comment_id VARCHAR(30), reply_comment_id VARCHAR(30), reasons reason[] NOT NULL, status status NOT NULL, description VARCHAR(200), reporter_key VARCHAR(30) NOT NULL, unique (platform, user_id, post_id, comment_id, reply_comment_id));
